...
from n3rverberage.init.analyzer.frameworks import FrameworkDetector
from n3rverberage.init.analyzer.mcp_recommender import MCPRecommender
from n3rverberage.init.analyzer.profile import ProjectProfile
...
logger = logging.getLogger("n3rverberage.init.analyzer")
...
def analyze_project(root: Path, context: ProjectContext) -> ProjectProfile:
    ...
    try:
        ...
        from n3rverberage.init.analyzer.profile import StructureInfo as _SI
