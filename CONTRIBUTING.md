...
You're already in the NERV repo. For other projects in this ecosystem, install NERV and run `nerv init` to set up the SDD workflow, A2A hub, and OpenCode integration.

For this project itself, all NERV integration is already configured — see `.opencode/agents/nerv.md` for available commands, skills, and SDD agents.
